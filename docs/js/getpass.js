...
var Tools_3=document.getElementById("passColor");
	...
	var colorArray = new Array("", "", "", "", "", "", "", "red", "red", "red", "teal", "olive", "purple", "grey", "teal", "olive", "purple", "grey", "teal", "olive", "purple", "grey","teal","");
...
Tools_1.innerHTML=da_1;
	...
	Tools_3.style.background = colorArray[hour];
}
